...
HD_PWD='D:/Desktop/vivadopj/Lab1design/Lab1design.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log calculater.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source calculater.tcl -notrace
