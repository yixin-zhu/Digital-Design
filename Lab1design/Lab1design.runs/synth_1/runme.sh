...
HD_PWD='D:/Desktop/vivadopj/Lab1design/Lab1design.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log calculater.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source calculater.tcl
